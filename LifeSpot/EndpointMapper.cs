    ...
    public static class EndpointMapper {
        ...
        public static void MapImage(this IEndpointRouteBuilder builder) {
            ...
            foreach(var image in imageFiles) {
                builder.MapGet($"/Views/Image/{image}", async context => {
                    var imagePath = Path.Combine(Directory.GetCurrentDirectory(), "Views", "Image", image);
                    var jpg = await File.ReadAllBytesAsync(imagePath);
